...
// CUSTOM CODE FOR PRODUCT STICKY HEADER BY TOM HUANG

// When the user scrolls the page, execute myFunction
window.onscroll = function() {myFunction()};

// Get the header
var header = document.querySelector(".product-sticky-header");

// Get the offset position of the navbar
var sticky = document.querySelector(".add-to-cart").offsetTop;
